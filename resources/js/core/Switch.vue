<template>
<div :class="'form-check text-center form-switch ' + labelclass">
    <input class="form-check-input" type="checkbox" :checked="checked ? true: false" @change="$emit('update:checked', $event.target.checked)">
</div>
</template>
